...
<body>
  ...
  <center>
    <div id="headerSection">
      <a href="../indexx.php"><button id="back-button"> Back</button></a>
  ...
  <div id="mainSection">
    ...
    <div id="groupSection">
      ...
      ?>
      <div id="groupSection1">
        <img id="groupimage" src="../uploads/<?php echo $groups[$i]['photo']?>">
        <b>Group Name : </b><?php echo $groups[$i]['name']?><br><br>
        <b>Votes :</b> <?php echo $groups[$i]['votes']?><br><br>
        <form method="POST" action="../apps/vote.php">
      ...
      ?>
          ...
          ?>
          <button style="padding: 5px; font-size: 15px; background-color: #3498db; color: white; border-radius: 5px;"
